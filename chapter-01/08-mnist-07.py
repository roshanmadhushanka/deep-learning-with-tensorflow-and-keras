...
if __name__ == '__main__':
    ...
    for LEARNING_RATE in [0.1, 0.01, 0.001]:
        accuracy = train()
        print('Learning Rate : {} -> Accuracy : {}'.format(DROPOUT, accuracy))
        if accuracy > max_accuracy:
            max_accuracy = accuracy
            max_accuracy_learning_rate = LEARNING_RATE
    print('Max Accuracy                  : {}'.format(max_accuracy))
    print('Learning Rate at Max Accuracy : {}'.format(max_accuracy_learning_rate))
# Find best learning hidden layer
...
if __name__ == '__main__':
    ...
    for N_HIDDEN in [128, 256, 512, 1024, 2048]:
        ...
        if accuracy > max_accuracy:
            ...
            max_accuracy_hidden_layer = N_HIDDEN
    print('Max Accuracy                 : {}'.format(max_accuracy))
    print('Hidden Layer at Max Accuracy : {}'.format(max_accuracy_hidden_layer))